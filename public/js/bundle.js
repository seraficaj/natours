...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2VyYWZpY2FqIiwiYSI6ImNrcGhwZHYwZDByNzAydW85dmExYTY4a2EifQ.M7XF43ELi_wcupoL0tVv5w';
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: 'localhost:3000/api/v1/users/logout'
            });
